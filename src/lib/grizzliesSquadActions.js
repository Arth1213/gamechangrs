...
export function threatButtonClass(tone) {
  ...
  if (tone === "red") return `${base} border-red-400/85 bg-red-500/25 text-red-200 hover:bg-red-500/45`;
  if (tone === "amber") return `${base} border-amber-300/85 bg-amber-400/20 text-amber-200 hover:bg-amber-400/40`;
  return `${base} border-emerald-300/85 bg-emerald-500/20 text-emerald-200 hover:bg-emerald-500/40`;
}
