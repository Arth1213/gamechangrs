...
const CHAT_QUERY_SCHEMA = [
  ...
  "- player: id, display_name, canonical_name, primary_role, primary_role_bucket, batting_style, batting_hand, batting_style_bucket, bowling_style, bowling_arm, bowling_style_bucket, bowling_style_detail, is_wicketkeeper",
  ...
  "- player_intelligence_matchup: series_id, scope_type, division_id, player_id, perspective, split_group, split_value, split_label, phase_bucket, match_count, delivery_events, legal_balls, runs_scored, runs_conceded, dismissals, wickets, dot_balls, boundaries, wides, no_balls, strike_rate, economy, batting_average, balls_per_dismissal, balls_per_wicket, dot_ball_pct, boundary_ball_pct, control_error_pct",
  "- player_intelligence_dismissal: series_id, scope_type, division_id, player_id, bowler_style_bucket, bowler_style_label, dismissal_type, dismissal_count, match_count, average_runs_at_dismissal, average_balls_faced_at_dismissal",
  "- player_intelligence_profile: series_id, scope_type, division_id, player_id, batting_match_count, bowling_match_count, batting_legal_balls, bowling_legal_balls, batting_rotation_ratio, batting_high_leverage_strike_rate, bowling_high_leverage_economy, bowling_pressure_control_error_pct, boundary_dot_threshold, dismissal_dot_threshold, boundary_after_three_dots_pct, dismissal_after_three_dots_pct",
