...
import { grizzliesWelcomeParts } from "@/lib/grizzliesWelcome";
...
export default function AnalyticsGrizzlies2026() {
  ...
  const welcome = grizzliesWelcomeParts(user);
