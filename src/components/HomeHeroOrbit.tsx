export const HomeHeroOrbit = () => {
  return (
    <div className="relative mx-auto flex w-full max-w-[560px] items-center justify-center">
      <div className="relative h-[360px] w-[360px] overflow-hidden rounded-[38px] border border-white/8 bg-[linear-gradient(180deg,rgba(7,11,17,0.98),rgba(10,15,23,0.98)_44%,rgba(5,10,15,1))] shadow-[0_32px_100px_rgba(0,0,0,0.45)] sm:h-[420px] sm:w-[420px]">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_10%,rgba(255,255,255,0.08),transparent_22%),radial-gradient(circle_at_50%_100%,rgba(34,197,94,0.12),transparent_30%)]" />
        <div className="absolute inset-x-[8%] top-[16%] h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />
        <div className="absolute left-[7%] top-[14%] h-[76px] w-[76px] rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.22),rgba(255,255,255,0.03)_50%,transparent_72%)] blur-xl" />
        <div className="absolute right-[8%] top-[12%] h-[88px] w-[88px] rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.18),rgba(255,255,255,0.03)_48%,transparent_72%)] blur-xl" />
        ...
        >
          <defs>
            <linearGradient id="pitch" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="rgba(156,116,68,0.94)" />
              <stop offset="100%" stopColor="rgba(86,56,29,0.98)" />
            </linearGradient>
          ...
          <path
            ...
            opacity="0.96"
          />
          <path d="M128 286H292" stroke="url(#crease)" strokeWidth="3" opacity="0.92" />
          <path d="M154 224H266" stroke="rgba(255,255,255,0.26)" strokeWidth="1.2" opacity="0.56" />
          <path d="M176 176H244" stroke="rgba(255,255,255,0.16)" strokeWidth="1" opacity="0.5" />
