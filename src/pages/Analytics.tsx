...
function SeriesOnboardingRequestPanel({
  requesterName,
  requesterEmail,
  requesterUserId,
}: {
  ...
  return (
    <Card className="border-border/80 bg-card/85 shadow-xl">
      <CardHeader className="space-y-3">
        ...
        <div className="space-y-2">
          <CardTitle className="font-display text-2xl text-foreground">Request new series onboarding</CardTitle>
          <CardDescription className="max-w-3xl text-sm leading-7">
            Submit the minimum onboarding details here. The platform admin will receive your email, phone number, and
            source details so they can continue the setup offline.
          </CardDescription>
        </div>
      </CardHeader>
      <CardContent className="space-y-5">
        <div className="grid gap-4 lg:grid-cols-2">
          <div className="space-y-2">
            <Label htmlFor="series-requester-name">Your name</Label>
            <Input
              id="series-requester-name"
          ...
          <div className="space-y-2">
            <Label htmlFor="series-requester-email">Your email</Label>
            <Input
              id="series-requester-email"
              type="email"
          ...
          <div className="space-y-2">
            <Label htmlFor="series-requester-phone">Phone number</Label>
            <Input
              id="series-requester-phone"
          ...
          <div className="space-y-2">
            <Label htmlFor="series-requester-organization">Organization / club</Label>
            <Input
              id="series-requester-organization"
          ...
          <div className="space-y-2">
            <Label htmlFor="series-request-source-system">Source system</Label>
            <Select
            ...
            >
              <SelectTrigger id="series-request-source-system">
          ...
          <div className="space-y-2">
            <Label htmlFor="series-request-season-year">Season year</Label>
            <Input
              id="series-request-season-year"
          ...
          <div className="space-y-2">
            <Label htmlFor="series-request-series-name">Series name</Label>
            <Input
              id="series-request-series-name"
          ...
          <div className="space-y-2">
            <Label htmlFor="series-request-age-group">Target age group</Label>
            <Input
              id="series-request-age-group"
        ...
        <div className="space-y-2">
          <Label htmlFor="series-request-url">Source series URL</Label>
          <Input
            id="series-request-url"
        ...
        <div className="space-y-2">
          <Label htmlFor="series-request-notes">Notes for the platform admin</Label>
          <Textarea
            id="series-request-notes"
        ...
        <div className="flex flex-wrap gap-3">
          <Button type="button" onClick={() => void handleSubmitRequest()} disabled={submitStatus === "saving"}>
            {submitStatus === "saving" ? "Submitting request..." : "Request new series onboarding"}
          </Button>
        </div>
      </CardContent>
    </Card>
                  ...
                  <div className="space-y-2">
                    ...
                    <CardDescription className="max-w-2xl text-sm leading-7">
                      {isPlatformAdminViewer
                        ...
                        : "Your account does not have series access yet. Request series-user or series-admin access, or send a new series onboarding request to the platform admin team."}
                    </CardDescription>
                  </div>
                </CardHeader>
                  ...
                  <div className="rounded-2xl border border-border/80 bg-background/60 p-5">
                    ...
                    <div className="mt-4 space-y-3 text-sm leading-7 text-muted-foreground">
                      {isPlatformAdminViewer ? (
                        ...
                        <>
                          <p>1. Choose an existing series and request series-user or series-admin access if it already exists.</p>
                          <p>2. If the series is not available yet, submit the new series onboarding form.</p>
                          <p>3. The platform admin receives your email and phone number for offline follow-up.</p>
                          <p>4. Recheck access after the team confirms the setup.</p>
                        </>
                      )}
                    </div>
                    {!isPlatformAdminViewer ? (
                      <div className="mt-5 space-y-4">
                        {requestableSeriesEntries.length > 0 ? (
                          ...
                          <div className="rounded-2xl border border-border/80 bg-background/70 p-4 text-sm leading-6 text-muted-foreground">
                            No requestable series are visible yet. Use the onboarding request below if your series has not been added.
                          </div>
                        )}
