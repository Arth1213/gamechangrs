...
const AnalyticsIntelligenceReport = () => {
  ...
  const heroSummaryItems = [
    ...
    { label: "Primary Role", value: roleLabel || "-" },
    { label: "Batting Profile", value: battingStyleLabel },
    { label: "Bowling Profile", value: bowlingStyleLabel },
    { label: "Confidence", value: confidenceValue, emphasis: recommendationTone === "risk" ? "risk" : "good" },
    { label: "Percentile", value: formatOrdinal(intelligenceReport?.header?.percentileRank), emphasis: "good" },
    { label: "Composite Score", value: formatNumber(intelligenceReport?.header?.compositeScore), emphasis: "good" },
  ] as const;
          ...
          <div className="mx-auto max-w-7xl space-y-8">
            <div className="space-y-5">
              <div className="space-y-4">
                ...
                <Card className="overflow-hidden border border-cyan-400/15 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.14),transparent_26%),radial-gradient(circle_at_bottom_right,rgba(34,197,94,0.1),transparent_22%),rgba(7,23,33,0.96)] shadow-[0_26px_80px_rgba(2,6,23,0.42)]">
                  <CardContent className="p-6 md:p-8">
                    <div className="flex justify-center">
                      <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-5 py-2 text-sm font-semibold uppercase tracking-[0.22em] text-slate-100">
                    ...
                    <div className="mt-6 border-t border-cyan-400/12 pt-8">
                      <div className="space-y-5">
                        ...
                        <p className="max-w-6xl text-lg leading-9 text-slate-100 md:text-[1.65rem] md:leading-[1.5]">
                          {heroNarrative}
                        </p>
                              ...
                              className={`rounded-[24px] border p-5 ${
                                item.emphasis === "risk"
                                  ...
                                  : item.emphasis === "good"
                                    ...
                                    : "border-cyan-400/12 bg-slate-950/25"
                              }`}
                            >
                              <p className="text-xs font-medium uppercase tracking-[0.22em] text-slate-300">{item.label}</p>
                              <p className="mt-4 text-2xl font-semibold leading-snug text-slate-50">{item.value}</p>
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            {intelligenceStatus === "success" && intelligenceReport ? (
              <>
                <Card className="border-cyan-400/15 bg-[radial-gradient(circle_at_top_left,rgba(14,116,144,0.12),transparent_34%),rgba(9,20,29,0.94)] shadow-xl">
                  ...
                  <CardContent className="space-y-8 pt-6">
                    <section className="grid gap-4 xl:grid-cols-2">
                      <div className="flex h-full flex-col rounded-2xl border border-cyan-400/10 bg-slate-950/35 p-5">
                ...
                <Card className="border-cyan-400/15 bg-[radial-gradient(circle_at_top_left,rgba(14,116,144,0.1),transparent_36%),rgba(9,20,29,0.94)] shadow-xl">
                  <CardHeader className="space-y-4 pb-0">
                    <div className="flex flex-wrap items-center gap-3">
                      <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.22em] text-cyan-200">
